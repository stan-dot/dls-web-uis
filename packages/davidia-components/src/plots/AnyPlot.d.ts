...
import { Aspect, AxisScaleType, ColorMap, ColorScaleType, Domain } from '@h5web/lib';
...
interface PlotSelectionProps {
    ...
    addSelection?: (selection: SelectionBase | null, broadcast?: boolean, clear?: boolean) => void;
    /** The selections */
...
type AnyPlotProps = LinePlotProps | ImagePlotProps | HeatmapPlotProps | ScatterPlotProps | SurfacePlotProps | TableDisplayProps;
/**
 * Represents Axes parameters.
 ...
 */
declare function AnyPlot(props: AnyPlotProps): import("react/jsx-runtime").JSX.Element | null;
export type { AnyPlotProps, AxesParameters, BatonProps, DAxesParameters, DLineData, HeatmapPlotProps, ImagePlotProps, LinePlotProps, MP_NDArray, PlotSelectionProps, ScatterPlotProps, SurfacePlotProps, TableDisplayParams, TableDisplayProps, TableDisplayType, };
export default AnyPlot;
//# sourceMappingURL=AnyPlot.d.ts.map